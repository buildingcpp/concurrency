...
namespace
{
    ...
    static_assert(bcpp::detail::signal_tree_layout<0>::node_count == 1);
    static_assert(bcpp::detail::signal_tree_layout<1>::level_node_count<0>() == 8);
    static_assert(bcpp::detail::signal_tree_layout<1>::level_offset<1>() == 8);
    static_assert(bcpp::detail::signal_tree_layout<1>::node_count == 9);
    static_assert(bcpp::detail::signal_tree_layout<2>::level_node_count<0>() == 32);
    static_assert(bcpp::detail::signal_tree_layout<2>::level_offset<1>() == 32);
    static_assert(bcpp::detail::signal_tree_layout<2>::level_node_count<1>() == 4);
    static_assert(bcpp::detail::signal_tree_layout<2>::level_offset<2>() == 36);
    static_assert(bcpp::detail::signal_tree_layout<2>::node_count == 37);
    ...
    static_assert(sizeof(bcpp::signal_tree<0>) == 64);
    static_assert(sizeof(bcpp::signal_tree<1>) == 576);
    static_assert(sizeof(bcpp::signal_tree<2>) == 2'368);
    static_assert(std::is_standard_layout_v<bcpp::signal_tree<0>>);
    static_assert(std::is_standard_layout_v<bcpp::signal_tree<1>>);
    static_assert(std::is_standard_layout_v<bcpp::signal_tree<2>>);
