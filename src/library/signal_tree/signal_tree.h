...
template <bcpp::concurrency::selector_concept Selector,
        typename bcpp::concurrency::signal_tree<tree_depth, mode>::wrap_policy policy>
[[gnu::always_inline]] inline bcpp::concurrency::signal_id bcpp::concurrency::signal_tree<tree_depth, mode>::select
(
    signal_id & hint
) noexcept
{
...
template <std::size_t tree_depth, bcpp::synchronization_mode mode>
template <bcpp::concurrency::selector_concept Selector,
        typename bcpp::concurrency::signal_tree<tree_depth, mode>::wrap_policy policy, bool report_cardinality>
[[gnu::always_inline]] inline bcpp::concurrency::signal_id bcpp::concurrency::signal_tree<tree_depth, mode>::select
(
    signal_id & hint
...
template <bcpp::concurrency::selector_concept Selector,
        typename bcpp::concurrency::signal_tree<tree_depth, mode>::wrap_policy policy, bool report_cardinality>
[[gnu::always_inline]] inline typename bcpp::concurrency::signal_tree<tree_depth, mode>::select_result
bcpp::concurrency::signal_tree<tree_depth, mode>::select
(
    signal_id & hint
...
template <bcpp::concurrency::selector_concept Selector,
        typename bcpp::concurrency::signal_tree<tree_depth, mode>::wrap_policy policy, bool report_cardinality>
[[gnu::always_inline]] inline auto bcpp::concurrency::signal_tree<tree_depth, mode>::select_impl
(
    signal_id & hint
) noexcept
{
...
template <std::size_t tree_depth, bcpp::synchronization_mode mode>
template <bcpp::concurrency::selector_concept Selector,
        typename bcpp::concurrency::signal_tree<tree_depth, mode>::wrap_policy policy, typename Rep, typename Period>
inline bcpp::concurrency::signal_id bcpp::concurrency::signal_tree<tree_depth, mode>::select
(
    signal_id & hint,
...
template <bcpp::concurrency::selector_concept Selector,
        typename bcpp::concurrency::signal_tree<tree_depth, mode>::wrap_policy policy>
inline bcpp::concurrency::signal_id bcpp::concurrency::signal_tree<tree_depth, mode>::try_select
(
    signal_id & hint
) requires (blocking)
{
...
//==============================================================================
template <std::size_t tree_depth, bcpp::synchronization_mode mode>
inline void bcpp::concurrency::signal_tree<tree_depth, mode>::stop
(
...
//==============================================================================
template <std::size_t tree_depth, bcpp::synchronization_mode mode>
inline std::uint64_t bcpp::concurrency::signal_tree<tree_depth, mode>::non_empty_tree_count
(
...
//==============================================================================
template <std::size_t tree_depth, bcpp::synchronization_mode mode>
inline bool bcpp::concurrency::signal_tree<tree_depth, mode>::set
(
    signal_id index
) noexcept
{
...
template <std::size_t tree_depth, bcpp::synchronization_mode mode>
template <bool report_cardinality>
inline typename bcpp::concurrency::signal_tree<tree_depth, mode>::set_result bcpp::concurrency::signal_tree<tree_depth, mode>::set
(
    signal_id index
) noexcept requires (report_cardinality)
{
...
//==============================================================================
template <std::size_t tree_depth, bcpp::synchronization_mode mode>
inline bool bcpp::concurrency::signal_tree<tree_depth, mode>::empty
(
) const noexcept
{
...
template <std::size_t tree_depth, bcpp::synchronization_mode mode>
template <std::size_t current_level>
inline auto bcpp::concurrency::signal_tree<tree_depth, mode>::node
(
    signal_id signal
...
template <std::size_t tree_depth, bcpp::synchronization_mode mode>
template <std::size_t current_level, bool report_cardinality>
inline auto bcpp::concurrency::signal_tree<tree_depth, mode>::set
(
    signal_id signal
) noexcept
{
...
template <std::size_t current_level,
    ...
    requires bcpp::concurrency::node_traits<current_level>::is_leaf
inline bcpp::concurrency::signal_id bcpp::concurrency::signal_tree<tree_depth, mode>::select
(
    signal_id hint,
    signal_id & nextHintCandidate,
...
template <std::size_t current_level,
        typename bcpp::concurrency::signal_tree<tree_depth, mode>::wrap_policy policy,
        bool report_cardinality, typename Selector>
    requires (not bcpp::concurrency::node_traits<current_level>::is_leaf)
inline bcpp::concurrency::signal_id bcpp::concurrency::signal_tree<tree_depth, mode>::select
(
    signal_id hint,
    signal_id & nextHintCandidate,
