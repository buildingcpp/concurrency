...
//==============================================================================
template <>
struct std::hash<bcpp::concurrency::signal_id>
{
    std::size_t operator()(bcpp::concurrency::signal_id id) const noexcept
    {
        return std::hash<bcpp::concurrency::signal_id::value_type>{}(static_cast<bcpp::concurrency::signal_id::value_type>(id));
    }
};
