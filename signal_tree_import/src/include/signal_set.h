...
#include "./signal_tree/blocking_state.h"
...
inline bcpp::signal_set<tree_depth, mode>::signal_set
(
    std::size_t capacity
) :
...
//==============================================================================
template <std::size_t tree_depth, bcpp::synchronization_mode mode>
inline bool bcpp::signal_set<tree_depth, mode>::set
(
    signal_id signalId
) noexcept
{
...
inline bcpp::signal_id bcpp::signal_set<tree_depth, mode>::select
(
    signal_id & hint
) noexcept
{
...
//==============================================================================
template <std::size_t tree_depth, bcpp::synchronization_mode mode>
inline void bcpp::signal_set<tree_depth, mode>::stop
(
...
//==============================================================================
template <std::size_t tree_depth, bcpp::synchronization_mode mode>
inline std::uint64_t bcpp::signal_set<tree_depth, mode>::non_empty_tree_count
(
