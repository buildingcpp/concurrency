...
//==============================================================================
inline void bcpp::detail::blocking_state::increment
(
) noexcept
{
...
//==============================================================================
inline void bcpp::detail::blocking_state::decrement
(
) noexcept
{
...
//==============================================================================
template <typename Clock, typename Duration>
inline bool bcpp::detail::blocking_state::wait_until
(
...
//==============================================================================
inline void bcpp::detail::blocking_state::stop
(
) noexcept
{
    {
...
//==============================================================================
inline std::uint64_t bcpp::detail::blocking_state::count
(
) const noexcept
{
